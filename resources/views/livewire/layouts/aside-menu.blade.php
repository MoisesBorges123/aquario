<aside class="app-sidebar">
    ...
    <div class="app-sidebar__user">
        <div class="dropdown user-pro-body text-center">
            ...
            <div class="user-info">
                ...
                <span class="text-muted app-sidebar__user-name text-sm">Aquarista</span>
            </div>
        </div>
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="side-item side-item-category">Aquario</li>
        <li class="slide">
            <a class="side-menu__item"  href="{{route('aquarium')}}">
            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/></svg>
            <span class="side-menu__label">Meus Aquarios</span><span class="badge badge-info side-badge"><i class='fa fa-diamond'></i></span></a>
        </li>             
        <li class="side-item side-item-category">Configurações</li>
        <li class="slide">
            <a class="side-menu__item"  href="{{route('typeEquipment')}}">
            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/></svg>
            <span class="side-menu__label">Tipos Equipamentos</span></a>
        </li>
